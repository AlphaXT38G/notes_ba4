...
\subsection{Divide-and-conquer} % A retirer si besoin d'espace
{\centering\includegraphics[width=\linewidth,height=2.8cm,keepaspectratio]{images/divide-and-conquer.png}\par}
...
{\centering\includegraphics[width=\linewidth,height=4cm,keepaspectratio]{images/recursion-trees.png}\par}
...
{\centering\includegraphics[width=\linewidth,height=1.5cm,keepaspectratio]{images/max-crossing-subarray.png}\par}
...
\section{Heaps}
\textbf{Max-heap:} $A[\text{parent}(i)]\ge A[i]$.\\
\texttt{LEFT}$(i)=2i$,\ \texttt{RIGHT}$(i)=2i{+}1$,\ \texttt{PARENT}$(i)=\lfloor i/2\rfloor$

\begin{lstlisting}
MAX-HEAPIFY(A, i, n)   // subtrees already heaps
    l=LEFT(i); r=RIGHT(i)
...
\begin{prop}[title=Runtime]
\texttt{MAX-HEAPIFY}: $O(\lg n)$.\ \texttt{BUILD-MAX-HEAP}: $\Theta(n)$.
\end{prop}
...
\begin{center} % A retirer si besoin d'espace
  \includegraphics[width=\linewidth]{images/topological-sort.png}
\end{center}
...
\begin{center} % A retirer si besoin d'espace
  \includegraphics[width=\linewidth]{images/scc.png}
\end{center}
