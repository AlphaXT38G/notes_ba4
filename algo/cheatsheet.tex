...
$\Theta(n^2)$ worst, $\Theta(n)$ best. \textbf{Inv:} $A[1..j{-}1]$ sorted.
...
{\centering\includegraphics[width=\linewidth,height=3cm,keepaspectratio]{images/recursion-trees.png}\par}
