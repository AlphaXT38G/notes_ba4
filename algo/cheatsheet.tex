...
\begin{center}
\begin{tabular}{cc}
  \small Linked list & \small Tree \\
  \includegraphics[width=0.48\linewidth]{images/linkedList_representation.png} &
  \includegraphics[width=0.48\linewidth]{images/tree_representation.png}
\end{tabular}
\end{center}
...
Finds shortest paths from $s$. Runtime: $O(V+E)$.
\end{prop}
