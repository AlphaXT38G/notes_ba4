...
\begin{defnbox}[title=Representation]
Graphs are commonly represented using:
\begin{itemize}
    \item adjacency list (efficient for sparse graphs)
    \item adjacency matrix (efficient for dense graphs)
\end{itemize}
\end{defnbox}
...
\begin{defnbox}[title=Vertex]
A \textbf{vertex} (or node) is a fundamental element of a graph.  
It represents an entity or object in the structure.
\end{defnbox}
