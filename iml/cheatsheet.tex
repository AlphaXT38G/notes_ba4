...
\]
PCA minimizes reconstruction error among linear orthogonal projections. Keeping all \(D\) components loses no information and decorrelates features (uncorrelated = covariance matrix diagonal in the new space). Keep \(d\) such that:
\[
