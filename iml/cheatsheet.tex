...
\begin{warn}[title=kNN Tricks]
Small \(k\): flexible, outlier-sensitive, overfit risk. Large \(k\): smoother, underfit risk. Choose \(k\) by V/CV. \textbf{Normalize}.
\end{warn}
...
The minimizer of any regularized empirical risk can be written as:
\[
