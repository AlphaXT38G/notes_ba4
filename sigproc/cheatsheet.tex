...
Statistical properties are time-invariant. In practice, we use \textbf{Wide-Sense Stationarity (WSS)}, which only requires the first two moments to be time-invariant.
\end{defn}
...
\[ P_x(e^{j\omega}) = |X(\omega)|^2 = \mathrm{DTFT}\{r_x[k]\} \]
